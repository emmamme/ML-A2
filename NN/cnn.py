...
def CNNUpdate(model, eps, momentum):
    ...
    # Insert your code here.
    # Update the weights.
    model['dE_dW1_1'] = momentum * model['dE_dW1_1'] + eps * model['dE_dW1']
    model['dE_dW2_1'] = momentum * model['dE_dW2_1'] + eps * model['dE_dW2']
    model['dE_dW3_1'] = momentum * model['dE_dW3_1'] + eps * model['dE_dW3'] 
    model['dE_db1_1'] = momentum * model['dE_db1_1'] + eps * model['dE_db1']
    model['dE_db2_1'] = momentum * model['dE_db2_1'] + eps * model['dE_db2']
    model['dE_db3_1'] = momentum * model['dE_db3_1'] + eps * model['dE_db3']

    model['W1'] = model['W1'] - model['dE_dW1_1']
    model['W2'] = model['W2'] - model['dE_dW2_1']
    model['W3'] = model['W3'] - model['dE_dW3_1']
    model['b1'] = model['b1'] - model['dE_db1_1']
    model['b2'] = model['b2'] - model['dE_db2_1']
    model['b3'] = model['b3'] - model['dE_db3_1']
    ###########################
    #raise Exception('Not implemented')
...
def main():
    ...
    # model = Load('cnn_model_25.npz')
    # stats = Load('cnn_stats_25.npz')
    # title1 = 'cnn momentum=0.9 f1=8 num_filters_2=50 Cross Entropy'
    # title2 = 'cnn momentum=0.9 f1=8 num_filters_2=50 Accuracy'
    ...
    #            momentum, num_epochs, batch_size)[1]
